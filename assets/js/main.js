...
console.log(wordsList(myLongStr, 'adi'))
/*
 * #2
 *
...
console.log(getWeekDay('2022-06-27')); // понедельник
...
console.log(getLocalDay('2022-06-27')) // 1
...
console.log(getDateAgo('2022-06-27', 3)); // 24.06.2022
